...
COIN_TGZP='https://github.com/Aezora/Aezora/releases/download/v2.0.0.1/Aezora-Linux.zip'
COIN_BOOTSTRAP='https://github.com/Aezora/Aezora/releases/download/v2.0.0.1/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='aezora'
COIN_NAME_OLD='aezorad'
PROJECT_NAME='Aezora (AZR)'
COIN_EXPLORER='http://explorer.aezora.com'
COIN_PORT=14725
RPC_PORT=14724
...
cat << EOF > /root/aezora-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/aezora-general-info

cat << EOF > /root/aezora-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/aezora-fee-info

cat << EOF > /root/aezora-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/aezora-networkinfo

cat << EOF > /root/aezora-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/aezora-masternode-stats

cp /root/.bashrc /root/.bashrc.backup
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/aezorainfo/d' > /root/tmp
mv /root/tmp /root/.bashrc
echo -e "alias feestats='/root/aezora-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/aezora-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/aezora-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}aezora-cli getinfo${NC}, ${RED}aezora-cli getblockcount${NC}, ${RED}aezora-cli getmasternodewinners${NC} and ${RED}aezora-cli getblockchaininfo${NC} commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
